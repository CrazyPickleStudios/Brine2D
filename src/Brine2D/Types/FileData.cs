...
{
    /// <summary>
    /// <para>Data representing the contents of a file.</para>
    /// </summary>
    ...
    public class FileData
    {
        ...
        /// <summary>
        /// <para>Gets the extension of the FileData.</para>
        /// </summary>
        /// <param name="ext">The extension of the file the FileData represents.</param>
        /// <returns>
        /// <list type="bullet">
        /// <item><term>ext</term><description>The extension of the file the FileData represents.</description></item>
        /// </list>
        /// </returns>
        public string GetExtension(string ext) => throw new NotImplementedException();
        /// <summary>
        /// <para>Gets the filename of the FileData.</para>
        /// </summary>
        /// <param name="name">The name of the file the FileData represents.</param>
        /// <returns>
        /// <list type="bullet">
        /// <item><term>name</term><description>The name of the file the FileData represents.</description></item>
        /// </list>
        /// </returns>
        public string GetFilename(string name) => throw new NotImplementedException();
        /// <summary>
