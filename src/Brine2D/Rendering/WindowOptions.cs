...
public class WindowOptions
{
    ...
    /// </summary>
    [Required]
    [StringLength(100, ErrorMessage = "Window title cannot exceed 100 characters")]
    ...
    /// </summary>
    [Range(1, 7680, ErrorMessage = "Window width must be between 1 and 7680")]
    ...
    /// </summary>
    [Range(1, 4320, ErrorMessage = "Window height must be between 1 and 4320")]
