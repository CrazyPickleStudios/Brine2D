...
public class TilemapRenderer
{
    ...
    /// </summary>
    public void Render(Tilemap.Tilemap tilemap, IRenderer renderer, ICamera? camera = null)
    {
    ...
    /// </summary>
    private (int minX, int minY, int maxX, int maxY) GetVisibleTileRange(Tilemap.Tilemap tilemap, ICamera? camera)
    {
        if (camera == null)
        {
