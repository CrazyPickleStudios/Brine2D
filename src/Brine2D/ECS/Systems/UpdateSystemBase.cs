...
/// </summary>
public abstract class UpdateSystemBase : IUpdateSystem, IDisposable
{
    ...
    /// <summary>
    /// Called once before the first <see cref="Update"/> dispatch.
    ...
    void IUpdateSystem.Update(IEntityWorld world, GameTime gameTime)
    {
